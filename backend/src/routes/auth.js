...
api.post('/signup', async (req, res) => {
  ...
  const acceptedFields = ['firstname', 'lastname', 'email', 'birthdate', 'password', 'passwordConfirmation']
  ...
  const { firstname, lastname, email, birthdate, password, passwordConfirmation } = req.body
